...
### TCP-based protocol to be implemented by the dai.AuditorListen application
...
```
When you connect to the TCP interface of the **dai.AuditorListen**, you should receive an array of musicians that corresponds to your commands. You should also use `tcpdump` to monitor the UDP trafic in your system.
