...
### TCP-based protocol to be implemented by the dai.Auditor application
...
You should be able to start an **dai.Auditor** container with the following command:

```
$ docker run -d -p 2205:2205 dai/auditor
```

You should be able to connect to your **dai.Auditor** container over TCP and see that there is no active musician.
...
After this, you should be able to verify two points. Firstly, if you connect to the TCP interface of your **dai.Auditor** container, you should see that there is now one active musician (you should receive a JSON array with a single element). Secondly, you should be able to use `tcpdump` to monitor the UDP datagrams generated by the **Musician.src.Musician** container.

You should then be able to kill the **Musician.src.Musician** container, wait 5 seconds and connect to the TCP interface of the **dai.Auditor** container. You should see that there is now no active musician (empty array).
...
```
When you connect to the TCP interface of the **dai.Auditor**, you should receive an array of musicians that corresponds to your commands. You should also use `tcpdump` to monitor the UDP trafic in your system.
